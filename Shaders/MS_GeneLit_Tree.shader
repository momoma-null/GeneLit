Shader "MomomaShader/General/GeneLit_Tree"
{
    Properties
    {
        ...
        _TreeWind ("[ShurikenHeader(Tree Inputs)]Wind Vector(xyz) & Time Scale(w)", Vector) = (1, 0, 0, 0.2)
        ...
        _SheenColor ("[ShurikenHeader(Sheen,_SHEEN)][IfDef(_SHEEN)]Sheen Color", Color) = (0, 0, 0, 1)
        _SheenRoughness ("[IfDef(_SHEEN)]Sheen Roughness", Range(0, 1)) = 0.0
        ...
        _Thickness ("[ShurikenHeader(Refraction,Refraction_Type,None,Solid,Thin)][IfDef(!REFRACTION_TYPE_NONE)]Thickness", Float) = 0.5
        _MicroThickness ("[IfDef(REFRACTION_TYPE_THIN)]MicroThickness", Float) = 0.01
        _TransmittanceColor ("[IfDef(!REFRACTION_TYPE_NONE)]Transmittance Color", Color) = (0, 0, 0, 1)
        _Transmission ("[IfDef(!REFRACTION_TYPE_NONE)]Transmission", Range(0, 1)) = 0.0
        [ToggleUI] _AlphaAffectTransmission ("[IfDef(!REFRACTION_TYPE_NONE)]Alpha Affect Transmission", Float) = 0.0
